...
public class MyFirstInteractiveSwingApp2 
{
	...
	public static void main(String args[]) 
	{
		...
		dashboard.getPreviewPane().getReportPreviewArea().addReportActionListener(
			new ReportActionListener() 
			{
				...
				{
					String reportPath = projectBasePath + "/resources/my first report.prpt";
					final PreviewDialog report = new PreviewDialog(createReport(reportPath));
					report.pack();
