...
The second task is to update the 'reportPath' variable in the MyFirstSwingApp2 class.

------------------------------------------------------------------------
3. Tasks and instructions.
------------------------------------------------------------------------

As first task, please select MyFirstSwingApp1 class from Eclipse and run the application using the green button with the white arrow in the Run menu (or press Ctrl + F11).
Pressing the unique button in the new window with the 'Press me!' label, you will see a message in the Console panel.

As second task, please select MyFirstSwingApp2 class from Eclipse and run the application using the green button with the white arrow in the Run menu (or press Ctrl + F11)
Pressing the unique button in the new window with the 'Press me!' label, you will see the report.
